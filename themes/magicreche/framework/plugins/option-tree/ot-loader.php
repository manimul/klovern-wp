    ...
    private function constants() {
      ...
      if ( false == OT_THEME_MODE && false == OT_CHILD_THEME_MODE ) {
        ...
        if ( true == OT_CHILD_THEME_MODE ) {
          define( 'OT_DIR', trailingslashit( get_stylesheet_directory() ) . 'framework/plugins/' . trailingslashit( basename( dirname( __FILE__ ) ) ) );
          define( 'OT_URL', trailingslashit( get_stylesheet_directory_uri() ) . 'framework/plugins/' . trailingslashit( basename( dirname( __FILE__ ) ) ) );
        } else {
          define( 'OT_DIR', trailingslashit( get_template_directory() ) . 'framework/plugins/' . trailingslashit( basename( dirname( __FILE__ ) ) ) );
          define( 'OT_URL', trailingslashit( get_template_directory_uri() ) . 'framework/plugins/' . trailingslashit( basename( dirname( __FILE__ ) ) ) );
        }
      }

    ...
    echo '<div class="format-setting type-background ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">'; 
        ...
        echo '<div class="select-group">';
          ...
          $background_position = isset( $field_value['background-size'] ) ? esc_attr( $field_value['background-size'] ) : '';
          echo '<select name="' . esc_attr( $field_name ) . '[background-size]" id="' . esc_attr( $field_id ) . '-position" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';

...
add_filter( 'ot_recognized_background_size',      'compat_ot_recognized_background_size', 10, 2 );
...
/**
 * Filters the recognized background size array.
 *
 * Allows the old 'recognized_background_size' filter to 
 * change the new 'ot_recognized_background_size' return value.
 *
 * @return    array
 *
 * @access    public
 * @since     2.0
 */
if ( ! function_exists( 'compat_ot_recognized_background_size' ) ) {

  function compat_ot_recognized_background_size( $array, $id ) {
  
    return apply_filters( 'recognized_background_size', $array, $id );
